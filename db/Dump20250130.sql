...
--
-- Table structure for table `movement_progress`
--

DROP TABLE IF EXISTS `movement_progress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `movement_progress` (
  ...
  `tdwn` time DEFAULT NULL,
  `atd_offset` int DEFAULT NULL,
  `ata_offset` int DEFAULT NULL,
  `blk_offset` int DEFAULT NULL,
  `taxi_toff` int DEFAULT NULL,
  `taxi_ata` int DEFAULT NULL,
  `delay_codes` varchar(50) DEFAULT NULL,
  `cnl` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`flight`,`date`,`ac_reg`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tidy_transfer_info_arrivals`
--

DROP TABLE IF EXISTS `tidy_transfer_info_arrivals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tidy_transfer_info_arrivals` (
  `id` int NOT NULL AUTO_INCREMENT,
  `inbound_flight` varchar(20) NOT NULL,
  `inbound_sta` datetime NOT NULL,
  `inbound_ac_reg` varchar(20) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_connection` (`outbound_flight`,`inbound_flight`,`inbound_ac_reg`,`inbound_sta`),
  KEY `inbound_flight` (`inbound_flight`,`inbound_ac_reg`,`inbound_sta`),
  CONSTRAINT `tidy_transfer_info_arrivals_ibfk_1` FOREIGN KEY (`inbound_flight`, `inbound_ac_reg`, `inbound_sta`) REFERENCES `tidy_flight_arrivals` (`flight`, `ac_reg`, `sta`)
) ENGINE=InnoDB AUTO_INCREMENT=83471 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-01-30 21:34:15
